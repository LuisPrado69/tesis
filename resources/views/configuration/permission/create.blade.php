...
<div>
    ...
    <div class="row">
        <form role="form" action="{{ route('store.create.permissions.configuration') }}" method="post"
              class="form-horizontal form-label-left" id="config_permissions_create_fm" novalidate>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-lock"></i> {{ trans('configuration.permission.labels.new') }}</h2>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea name="description" id="description"
                                          ...
                                          placeholder="{{ trans('configuration.permission.labels.description') }}"></textarea>
                            </div>
                        </div>
...
<script>
    $(function() {
        let $form = $('#config_permissions_create_fm');
