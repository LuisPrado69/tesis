...
class RoleRepository extends Repository
{
    ...
    {
        return $this->model->whereNotIn('slug', ['developer'])->get();
    }
    ...
    public function changePermission(
        ...
        if (is_array($value)) {
            if ($filter6) {
                $actions[$action]['inner'][$filter1]['inner'][$filter2]['inner'][$filter3]['inner'][$filter4]['inner'][$filter5]['inner'][$filter6] = $this->_changePermission($value,
                    $allTrue);
            } elseif ($filter5) {
     ...
     * @return mixed
     */
    public function changeAllPermissions(
        $permission,
        $bases,
        $checked,
        string $filter1 = null,
                                                ...
                                                foreach ($value4['inner'] as $key5 => $value5) {
                                                    if ($key5 === $filter5) {
                                                        foreach ($value5['inner'] as $key6 => $value6) {
                                                            if ($key6 === $filter6) {
                                                                $actions[$key1]['inner'][$key2]['inner'][$key3]['inner'][$key4]['inner'][$key5]['inner'][$key6] = $this->_changePermission($value6,
                                                                    false, true, $checked);
                                                            }
                                                        }
                                                    }
                                    ...
                                    if ($key3 === $filter3) {
                                        foreach ($value3['inner'] as $key4 => $value4) {
                                            if ($key4 === $filter4) {
                                                foreach ($value4['inner'] as $key5 => $value5) {
                                                    if ($key5 === $filter5) {
                                                        $actions[$key1]['inner'][$key2]['inner'][$key3]['inner'][$key4]['inner'][$key5] = $this->_changePermission($value5, false,
                                                            true, $checked);
                                                    }
                                                }
                                            }
